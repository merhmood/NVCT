export default function Privacy() {
  return (
    <div className="w-4/5 max-w-7xl mx-auto mt-24 lg:mt-40">
      ...
      <p>
        {
          'NuttyVibes ("we," "us," or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our software-as-a-service ("SaaS") product based on a modified version of OpenEMR ("Service"). By accessing or using our Service, you agree to the terms of this Privacy Policy.'
        }
      </p>
      <div>
        <div className="mt-6">
        ...
        <div className="mt-6">
          ...
          <p className="mt-2">
            {
              "To exercise these rights, please contact us at contact@NuttyVibes.com."
            }
          </p>
        </div>
        <div className="mt-6">
        ...
        <div className="mt-6">
          ...
          <ul className="mt-3 mb-14">
            <li className="font-bold">NuttyVibes</li>
            <li>33 Marina Rd, Lagos Island.</li>
            <li>contact@NuttyVibes.com</li>
